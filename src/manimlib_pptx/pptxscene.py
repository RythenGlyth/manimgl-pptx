...
class PPTXScene(Scene):
    ...
    def __init__(self, *args, **kwargs):
        ...
        kwargs["file_writer_config"]["write_to_movie"] = True
        kwargs["file_writer_config"]["break_into_partial_movies"] = True
    ...
    def tear_down(self) -> None:
        super(PPTXScene, self).tear_down()
        ...
        partial_movie_files = get_sorted_integer_files(self.file_writer.partial_movie_directory)

        for tslidei, tslide in enumerate(self.slides):
            slide_movie_files =  partial_movie_files[tslide["start"]:tslide["end"]]
